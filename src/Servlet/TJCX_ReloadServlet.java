...
/**
 * Servlet implementation class TJCX_ReloadServlet
 */
@WebServlet("/templete/tJCX_ReloadServlet")
public class TJCX_ReloadServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TJCX_ReloadServlet() {
        super();
...
//		request.setAttribute("message", "123");
		request.getRequestDispatcher("tjcx_reload.jsp").forward(request, response);
