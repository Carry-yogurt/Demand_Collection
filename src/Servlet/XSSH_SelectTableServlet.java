...
/**
 * Servlet implementation class XSSH_SelectTableServlet
 */
@WebServlet("/templete/xSSH_SelectTableServlet")
public class XSSH_SelectTableServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public XSSH_SelectTableServlet() {
        super();
