						...
						<div class="container-fluid">
							<div class="row">
								...
								<div class="col-md-3" style="text-align: center;">
									<input required="required" name="bmshyj" id="bmshyj"
...
<script type="text/javascript">
	function shtg(type){
		...
		var bmshyj=document.getElementById("bmshyj");
		var xqid=${xb.xqid};
		//document.getElementById("shuaxin")
		//alert(glcs.value);
		if(type=="2"){
			//alert(type+"2");
			var url = "bMSH_Servlet?n="+n+"&xqid="+xqid;
		}else if(type=="3"){
			//alert(type+"3");
			if(bmshyj.value==""){
				alert("请填写形式审核意见");
			...
			var url = "bMSH_Servlet?n="+n+"&xqid="+xqid+"&bmshyj="+bmshyj.value;
		}
		alert(url);
