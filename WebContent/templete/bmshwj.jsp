...
<body>
	...
	<% 
		...
		%>
	<form class="form-inline" action="bMSH_SearchStatusServlet">
		<!-- 一键式搜索 -->
		<select class="form-control" name="cx_class"
			style="margin-left: 20px; margin-top: 20px;">
			<option value="-1">全部处室</option>
		...
		<tbody>
			...
			<c:forEach var="item" items="${xq_list}">
				<tr>
					...
					<td width="30%"><a href="bMSH_ReloadServlet?xqid=${item.xqid}">${item.zywt}</a></td>
